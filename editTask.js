...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let urlComplementGet = "/" + idToPass + "?token=NextLine12345678";
  ...
  editTaskForm.addEventListener("submit", (e) => {
    ...
    let urlComplementPut = "/" + idToPass + "?token=NextLine12345678";
  ...
  deleteTaskForm.addEventListener("click", (e) => {
    ...
    let urlComplementDelete = "/" + idToPass + "?token=NextLine12345678";
